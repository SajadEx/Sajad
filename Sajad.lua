...
local NameUser = "[- Sajad 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/Wllllllll)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- Sajad 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/Wllllllll)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
send(msg.chat_id_, msg.id_,"[- Sajad 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/Wllllllll)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "Sajad")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- Sajad TeAM .',url="t.me/Wllllllll"}},
}
local msg_id = msg.id_/2097152/0.5
...
[⌔︙ Sajad 𝖲𝗈𝗎𝗋𝖼𝖾  .](http://t.me/Wllllllll)
     
[⌔︙ Sajad Developer .](http://t.me/NFFFFFFF)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
inline = {
{{text = '⌔︙ Sajad 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/Wllllllll'}},
}
...
inline = {
{{text = '⌔︙ Sajad 𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/Wllllllll'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
