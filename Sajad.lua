...
if hash or Bot(msg) or DevSajad(msg) or DevBot(msg) or VIP_DeV(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevSajad(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevSajad(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevSajad(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevSajad(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) then             
return true 
else 
return false 
end 
...
os.execute('wget https://raw.githubusercontent.com/DevSajad/Sajad/master/Sajad.lua')
os.execute('wget https://raw.githubusercontent.com/DevSajad/Sajad/master/start.lua')
dofile('Sajad.lua')  
return false
end
if text == "راسلني" then
...
if DevSajad(msg) then
local Get_Files, res = https.request("https://rew.github.com/DevSajad/Sajad_Files/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://rew.github.com/DevSajad/Sajad_Files/master/Sajad_Files/"..file)
if res == 200 then
...
if text and text:match("^- تعين قناة الاشتراك•  .$") and DevSajad(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '• حسنآ ارسل لي معرف القناة')
return false  
end
...
if text == ("• مسح العام") and DevSajad(msg) then
database:del(bot_id.."Sajad:GBan:User")
send(msg.chat_id_, msg.id_, "\n• تم مسح العام")
return false
end
...
if text == ("• العام") and DevSajad(msg) then
local list = database:smembers(bot_id.."Sajad:GBan:User")
t = "\n• قائمة المحظورين عام \n \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Sajad:User:Name" .. v)
