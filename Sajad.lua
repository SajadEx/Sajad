...
if hash or Bot(msg) or SajadEx(msg) or VIP_DeV(msg) then    
return true  
else  
return false  
end  
...
if hash or Bot(msg) or SajadEx(msg) or DevBot(msg) or VIP_DeV(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or SajadEx(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or SajadEx(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or SajadEx(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  SajadEx(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) then             
return true 
else 
return false 
end 
...
if SajadExe(user_id) == true then
var = true
elseif SajadEx(user_id) == true then
var = true
...
elseif tonumber(user_id) == tonumber(1545322426) then  
var = "مطور السورس"  
elseif SajadExe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
...
local UserName = (data.username_ or "Wllllllll")
...
if text == ("الثانويين") and SajadEx(msg) then
...
if text == ("مسح قائمه العام") and SajadEx(msg) then
database:del(bot_id.."Sajad:GBan:User")
send(msg.chat_id_, msg.id_, "\n • تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين") and SajadEx(msg) then
...
if text == ("قائمه العام") and SajadEx(msg) then
...
if text == ("المطورين") and SajadEx(msg) then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and SajadEx(msg) then
function Function_Sajad(extra, result, success)
...
if text and text:match("^حظر عام @(.*)$")  and SajadEx(msg) then
...
if text and text:match("^حظر عام (%d+)$") and SajadEx(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and SajadEx(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
usertext = '\n *• اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Wllllllll')..')'
...
if text and text:match("^الغاء العام @(.*)$") and SajadEx(msg) then
...
function start_function(extra, result, success)
if result.id_ then
usertext = '\n *• اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'Wllllllll')..')'
status  = '\n*• تم الغاء (الحظر-الكتم) عام من الكروبات*'
...
if text and text:match("^الغاء العام (%d+)$") and SajadEx(msg) then
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and SajadEx(msg) then
function Function_Sajad(extra, result, success)
...
if text and text:match("^اضف مطور @(.*)$") and SajadEx(msg) then
...
if text and text:match("^اضف مطور (%d+)$") and SajadEx(msg) then
...
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and SajadEx(msg) then
function Function_Sajad(extra, result, success)
...
if text and text:match("^حذف مطور @(.*)$") and SajadEx(msg) then
...
if text and text:match("^حذف مطور (%d+)$") and SajadEx(msg) then
...
send(msg.chat_id_, msg.id_,"[- Sajad 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/FJJJJO)\n — — — — — — — — —\n• العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "FJJJJO")..")".."\n• تم رفعه "..RTPA.." هنا\n")
...
local num = database:smembers(bot_id.."Sajad:allM"..msg.chat_id_)
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and SajadEx(msg) then 
...
if text == ("ردود المطور") and SajadEx(msg) then 
local list = database:smembers(bot_id.."Sajad:List:Rd:Sudo")
text = "\n • قائمة ردود المطور \n\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and SajadEx(msg) then 
...
if text == "حذف رد للكل" and SajadEx(msg) then 
...
if database:sismember(bot_id.."Sajad:Sudo:User",result.sender_user_id_) then
dev = " • تم تنزيله من المطورين"
else 
dev = " • هو ليس مطور" 
end
if database:sismember(bot_id.."Sajad:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = " • تم تنزيل من الاساسيين" 
else 
crr = " • هو ليس منشئ اساسي" 
end
if database:sismember(bot_id.."Sajad:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = " • تم تنزيله من المنشئين" 
else 
cr = " • هو ليس منشئ" 
end
if database:sismember(bot_id.."Sajad:Manager"..msg.chat_id_, result.sender_user_id_) then
own = " • تم تنزيله من المدراء" 
else 
own = " • هو ليس مدير" 
end
if database:sismember(bot_id.."Sajad:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = " • تم تنزيله من الادميه"
 else 
mod = " • هو ليس ادمن" 
end
if database:sismember(bot_id.."Sajad:Special:User"..msg.chat_id_, result.sender_user_id_) then
...
database:srem(bot_id.."Sajad:Ban:User"..msg.chat_id_,result.id_)
database:srem(bot_id.."Sajad:Muted:User"..msg.chat_id_,result.id_)
usertext = "\n •  العضو ↺["..result.title_.."](t.me/"..(username or "Wllllllll")..")"
status  = "\n •  تم الغاء القيود عنه"
texts = usertext..status
send(msg.chat_id_, msg.id_,texts)
else
...
database:srem(bot_id.."Sajad:Muted:User"..msg.chat_id_,result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = "\n •  العضو ↺["..data.first_name_.."](t.me/"..(data.username_ or "Wllllllll")..")"
status  = "\n •  تم الغاء القيود عنه"
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
local UserName = (b.username_ or "Wllllllll")
...
database:sadd(bot_id.."Sajad:Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end
...
Namebot = (database:get(bot_id.."Sajad:Name:Bot") or "فيكتو")
local namebot = {
...
if database:get(bot_id.."Sajad:Status:Bc") and not SajadEx(msg) then 
...
if text == "تفعيل الاذاعه" and SajadEx(msg) then  
database:del(bot_id.."Sajad:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n • تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and SajadEx(msg) then  
...
if text == "تنظيف المشتركين" and SajadEx(msg) then
...
if text == "تنظيف الكروبات" and SajadEx(msg) then
...
if text == ("تحديث السورس") and SajadEx(msg) then  
...
zh = https.request('https://Sajad-source.tk/Sajad TeAm/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n • قائمه الزخرفه \n \n"
i = 0
...
st = https.request('https://Sajad-source.tk/Sajad TeAm/ImageInfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://Sajad-source.tk/Sajad TeAm/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
if text == 'جلب نسخه احتياطيه' and SajadEx(msg) then
local list = database:smembers(bot_id..'Sajad:Chek:Groups')  
...
if text == 'الملفات' and SajadEx(msg) then
t = '* • جميع الملفات : \n \n*'
i = 0
for v in io.popen('ls Sajad_Files'):lines() do
if v:match(".lua$") then
...
if SajadEx(msg) then
local Get_Files, res = https.request("https://rew.github.com/SajadEx/Sajad_Files/master/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and SajadEx(msg) then
...
local json_file, res = https.request("https://rew.github.com/SajadEx/Sajad_Files/master/Sajad_Files/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and SajadEx(msg) then
...
if text == "مسح جميع الملفات" and SajadEx(msg) then
os.execute("rm -fr Sajad_Files/*")
send(msg.chat_id_,msg.id_," • تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and SajadEx(msg) then
...
if text == 'حذف كليشه المطور' and SajadEx(msg) then
database:del(bot_id..'Sajad:Text_Dev')
send(msg.chat_id_, msg.id_,' •  تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and SajadEx(msg) then
...
if text == 'رفع النسخه الاحتياطيه' and SajadEx(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and SajadEx(msg) then
dofile("Sajad.lua")  
send(msg.chat_id_, msg.id_, "* • تم التحديث*")
end
...
Text = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n• [𝚅𝚎𝙲𝚝𝚘 𝖲𝗈𝗎𝗋𝖼𝖾 .](http://t.me/Wllllllll) \n• [𝚅𝚎𝙲𝚝𝚘 Developer .](http://t.me/NFFFFFF) \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• 𝚅𝚎𝙲𝚝𝚘 𝖲𝗈𝗎𝗋𝖼𝖾 .',url="t.me/Wllllllll"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Wllllllll&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Sajad:Num:Add:Bot') or 0) and not SajadEx(msg) then
...
if not SajadEx(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Sajad:Filter"..msg.sender_user_id_) then
...
if SajadEx(msg) and msg.reply_to_message_id_ ~= 0 then    
...
if text and text:match("^-• تغير الاشتراك .$") and SajadEx(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '• حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^-• تغير رساله الاشتراك .$") and SajadEx(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '• حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "• حذف رساله الاشتراك" and SajadEx(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "• تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^- تعين قناة الاشتراك•  .$") and SajadEx(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '• حسنآ ارسل لي معرف القناة')
return false  
end
if text == "• - تفعيل الاشتراك الاجباري  ." and SajadEx(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "• - تعطيل الاشتراك الاجباري  ." and SajadEx(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "• تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "• - الاشتراك الاجباري  ." and SajadEx(msg) then  
...
if text == ("• مسح العام") and SajadEx(msg) then
database:del(bot_id.."Sajad:GBan:User")
send(msg.chat_id_, msg.id_, "\n• تم مسح العام")
return false
end
...
if text == ("• العام") and SajadEx(msg) then
local list = database:smembers(bot_id.."Sajad:GBan:User")
t = "\n• قائمة المحظورين عام \n \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Sajad:User:Name" .. v)
...
if database:get(bot_id.."Sajad:Set:Manager:rd"..data.sender_user_id_..":"..data.chat_id_) then
database:del(bot_id.."Sajad:Set:Manager:rd"..data.sender_user_id_..":"..data.chat_id_)
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
local Name_Bot = (database:get(bot_id.."Sajad:Name:Bot") or "فيكتو")
