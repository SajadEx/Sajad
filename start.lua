...
print(":: Sajad::")
local RunBot = io.open("Sajad", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/Sajad
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr Sajad.lua
wget "https://raw.githubusercontent.com/SajadEx/Sajad/master/Sajad.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./Sajad.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S Sajad -X kill
screen -S Sajad ./Sajad
done
]])
RunTs:close()
end
